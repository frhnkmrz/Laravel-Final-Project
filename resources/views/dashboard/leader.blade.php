...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-8 text-center">
            <h1 class="display-3 text-primary mb-4 fw-bold">Leader Dashboard</h1>
            <p class="lead text-muted mb-4">View and manage grants, milestones, and project statuses with ease.</p>
